...
<article id="post-<?php the_ID(); ?>" <?php post_class('post-featured-item'); ?>>
	<div class="post-featured-gallery-wrap freesia-animation fadeInUp">
			...
			<div class="entry-thumb">
				...
				<?php if (current_theme_supports('post-formats', $format)) { ?>
					<div class="entry-meta">
						<?php printf(
							'<span class="entry-format"><a href="%1$s">%2$s</a></span>',
		...
		<div class="entry-details">
			<header class="entry-headerz">
				<?php if ($entry_format_meta_blog != 'hide-meta') {
					echo  '<div class="entry-meta">';
					if ($photograph_post_author != 1) {
						echo '<span class="author zzvcard"><a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '" title="' . the_title_attribute('echo=0') . '"><i class="fa fa-user-o"></i> ' . esc_html(get_the_author()) . '</a></span>';
					}
					if ($photograph_post_date != 1) {
						printf(
							'<span class="posted-on"><a href="%1$s" title="%2$s"><i class="fa fa-calendar-o"></i> %3$s </a></span>',
