                            ...
                            foreach ($photograph_list_tab_tags as $photograph_tag_list) :
                                ...
                                if ($i == 1) {
                                    ...
                                    if ($photograph_settings['photograph_feature_tab_all_text'] != '') {  ?>
                                        <button type="button" class="active" data-category="*"><?php echo esc_html($photograph_settings['photograph_feature_tab_all_text']); ?></button>
                                        <button type="button" data-category=".tag-<?php echo esc_attr($photograph_tag_list); ?>"><?php echo esc_html($post_tags->name); ?></button>
                                    <?php } else { ?>
                                        <button type="button" class="active" data-category=".tag-<?php echo esc_attr($photograph_tag_list); ?>"><?php echo esc_html($post_tags->name); ?></button>
                                    <?php }
                                } else { ?>
                                    <button type="button" data-category=".tag-<?php echo esc_attr($photograph_tag_list); ?>"><?php echo esc_html($post_tags->name); ?></button>
                            <?php }
