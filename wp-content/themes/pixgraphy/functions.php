...
function pixgraphy_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Main Menu', 'pixgraphy' )
	) );
	...
	*/ 
	...
	add_theme_support( 'custom-background', apply_filters( 'pixgraphy_custom_background_args', array(
...
if(!class_exists('Pixgraphy_Plus_Features')){
	class Pixgraphy_Customize_upgrade extends WP_Customize_Control {
		public function render_content() { ?>
			<a title="<?php esc_attr_e( 'Review Pixgraphy', 'pixgraphy' ); ?>" href="<?php echo esc_url( 'https://wordpress.org/support/view/theme-reviews/pixgraphy/' ); ?>" target="_blank" id="about_pixgraphy">
			<?php esc_html_e( 'Review Pixgraphy', 'pixgraphy' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://themefreesia.com/theme-instruction/pixgraphy/' ); ?>" title="<?php esc_attr_e( 'Theme Instructions', 'pixgraphy' ); ?>" target="_blank" id="about_pixgraphy">
			<?php esc_html_e( 'Theme Instructions', 'pixgraphy' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://tickets.themefreesia.com/' ); ?>" title="<?php esc_attr_e( 'Support Ticket', 'pixgraphy' ); ?>" target="_blank" id="about_pixgraphy">
	...
	$wp_customize->add_control(
		new Pixgraphy_Customize_upgrade(
		$wp_customize,
		'pixgraphy_upgrade_links',
			array(
				'section'				=> 'pixgraphy_upgrade_links',
				'settings'				=> 'pixgraphy_upgrade_links',
			)
		)
	);
}	
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'pixgraphy_customize_partial_blogname',
		) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector' => '.site-description',
			'container_inclusive' => false,
			'render_callback' => 'pixgraphy_customize_partial_blogdescription',
		) );
	}
