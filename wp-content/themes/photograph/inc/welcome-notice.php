  ...
  if ( !get_user_meta( $current_user_id, esc_html( $theme->get( 'TextDomain' ) ) . '_notice_ignore' ) ) {
    ...
    <div class="notice photograph-notice" style="position:relative;">
      ...
      <h1>
        ...
        printf( esc_html__( 'Welcome to %1$s - Version %2$s', 'photograph' ), esc_html( $theme->Name ), esc_html( $theme->Version ) );
        ?>
      </h1>
      ...
      <p>
        ...
        printf( __( 'Welcome! Thank you for choosing %1$s! View  <a href="%2$s" target="_blank" class="notice-links">Multiple Demos</a> <a href="%3$s" target="_blank" class="notice-links">Documentation</a>', 'photograph' ), esc_html( $theme->Name ), 'https://themefreesia.com/demos/photograph-demos/', 'https://themefreesia.com/theme-instruction/photograph/' );
...
add_action( 'admin_notices', 'photograph_admin_notice' );

function photograph_notice_ignore() {
  global $current_user;
...
add_action( 'admin_init', 'photograph_notice_ignore' );